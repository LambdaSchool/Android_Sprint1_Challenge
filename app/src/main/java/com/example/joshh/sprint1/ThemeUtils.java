...
public class ThemeUtils {
    static int getSelectedTheme(Activity activity){
        ...
        boolean darkTheme = preferences.getBoolean(activity.getResources().getString(R.string.theme_switch_key), false);
        int selectedThemeId = darkTheme ? R.style.AppDarkTheme : R.style.AppTheme;
